...
//Datos de WiFi
const char* ssid = "Hulk";  // Aquí debes poner el nombre de tu red
const char* password = "QuieroINTERNET10";  // Aquí debes poner la contraseña de tu red
...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == "esp32/output") {  // En caso de recibirse mensaje en el tema esp32/output
    ...
    }// fin del if (String(topic) == "codigoIoT/SIC/mqtt")
...
void reconnect() {
  ...
  while (!client.connected()) { // Pregunta si hay conexión
    ...
    if (client.connect("ESP32CAMClient")) { //Pregunta por el resultado del intento de conexión
      ...
      client.subscribe("codigoIoT/SIC/mqtt"); // Esta función realiza la suscripción al tema
